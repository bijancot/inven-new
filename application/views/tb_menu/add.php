    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tb Menu Add</h3>
            </div>
            <?php echo form_open('tb_menu/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="namaMenu" class="control-label"><span class="text-danger">*</span>NamaMenu</label>
						<div class="form-group">
							<input type="text" name="namaMenu" value="<?php echo $this->input->post('namaMenu'); ?>" class="form-control" id="namaMenu" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="menuDesc" value="<?php echo $this->input->post('menuDesc'); ?>" class="form-control" id="menuDesc" />
