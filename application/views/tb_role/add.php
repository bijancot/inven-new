    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tb Role Add</h3>
            </div>
            <?php echo form_open('tb_role/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="namaRole" class="control-label"><span class="text-danger">*</span>NamaRole</label>
						<div class="form-group">
							<input type="text" name="namaRole" value="<?php echo $this->input->post('namaRole'); ?>" class="form-control" id="namaRole" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="keteranganRole" value="<?php echo $this->input->post('keteranganRole'); ?>" class="form-control" id="keteranganRole" />
