    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tb Detil Barang Edit</h3>
            </div>
			<?php echo form_open('tb_detil_barang/edit/'.$tb_detil_barang['idDetilBarang']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idBarang" class="form-control">
								...
								{
									$selected = ($tb_barang['idBarang'] == $tb_detil_barang['idBarang']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idJenis" class="form-control">
								...
								{
									$selected = ($tb_jenis_barang['idJenis'] == $tb_detil_barang['idJenis']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tahunPengadaan" value="<?php echo ($this->input->post('tahunPengadaan') ? $this->input->post('tahunPengadaan') : $tb_detil_barang['tahunPengadaan']); ?>" class="form-control" id="tahunPengadaan" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="kondisiBarang" value="<?php echo ($this->input->post('kondisiBarang') ? $this->input->post('kondisiBarang') : $tb_detil_barang['kondisiBarang']); ?>" class="form-control" id="kondisiBarang" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="qtyBarang" value="<?php echo ($this->input->post('qtyBarang') ? $this->input->post('qtyBarang') : $tb_detil_barang['qtyBarang']); ?>" class="form-control" id="qtyBarang" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="keteranganBarang" value="<?php echo ($this->input->post('keteranganBarang') ? $this->input->post('keteranganBarang') : $tb_detil_barang['keteranganBarang']); ?>" class="form-control" id="keteranganBarang" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fotoBarang" value="<?php echo ($this->input->post('fotoBarang') ? $this->input->post('fotoBarang') : $tb_detil_barang['fotoBarang']); ?>" class="form-control" id="fotoBarang" />
